...
[![x-cmd/install — ruff Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/ruff.svg?lang=zh)](https://x-cmd.com/install/ruff)
...
合计: **753,586** 行代码（覆盖前 5 种语言、共 **5296** 个文件）。
...
- **上游仓库**: <https://github.com/astral-sh/ruff>
...
- **Star**: 49,734 · **Fork**: 2,432 · **开放 issue**: 8,322 · **贡献者**: 959

## 累计统计

- **发布数**: 428 · **已合并 PR**: 16542 · **开放 PR**: 498 · **已关闭 issue**: 6609 · **开放 issue**: 1713 · **提交数**: 17324
...
ruff 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `ruff` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/ruff.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T02:47:13Z._
